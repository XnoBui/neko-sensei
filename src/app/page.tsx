...
const features = [
  ...
  },
  {
    href: "/kanji",
    icon: "漢",
    tint: "from-ios-orange/20 to-ios-pink/10",
    iconColor: "text-ios-orange",
    title: "Kanji Study",
    blurb: "The 100 core N5 kanji with readings and examples.",
  },
  {
    href: "/vocab",
    icon: "📚",
  ...
  },
  {
    href: "/grammar",
    icon: "文",
    tint: "from-ios-pink/20 to-ios-indigo/10",
    iconColor: "text-ios-pink",
    title: "Grammar Drills",
    blurb: "20 core N5 patterns with examples and fill-in-the-blank drills.",
  },
  {
    href: "/mock",
    icon: "📝",
    tint: "from-ios-red/20 to-ios-orange/10",
    iconColor: "text-ios-red",
    title: "Mock Test",
    blurb: "Timed N5 practice test with pass/fail scoring and review.",
  },
  {
    href: "/chat",
    icon: "💬",
