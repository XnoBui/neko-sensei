...
// Gojūon — the 46 base characters (some positions are empty in the traditional chart)
export const hiraganaGojuon: (KanaPair | null)[] = [
...
export const hiraganaDakuon: KanaPair[] = [
...
export const katakanaGojuon: (KanaPair | null)[] = [
...
export const katakanaDakuon: KanaPair[] = [
...
function compact(grid: (KanaPair | null)[]): KanaPair[] {
  return grid.filter((x): x is KanaPair => x !== null);
}

// Flat lists for drill mode (all learnable characters for each script)
export const hiragana: KanaPair[] = [
  ...compact(hiraganaGojuon),
  ...hiraganaDakuon,
  ...hiraganaHandakuon,
  ...hiraganaYoon,
];
